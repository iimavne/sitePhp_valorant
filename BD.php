...
<a href="https://th.bing.com/th/id/OIP.kxtVdAFwm8nZBNV2YztZogHaEK?rs=1&pid=ImgDetMain">
	<img alt="texte alternatif pour le lien image" src="image/valorant.jpg" width="120" height="75" /><br>
</a>
...
$result= mysqli_query($link,$query);
 ...
 while ($donnees=mysqli_fetch_assoc($result)) { //tableau avc tt les champs et leur données
       $nom=$donnees["nom"];//on recup les donnée du champ ville
       $image=$donnees["image"];//on recup les donnée de la table indice
       echo "<h2>$nom</h2>";
       print "<img src='$image' alt='$nom' width='120' height='75'><br>";
}
